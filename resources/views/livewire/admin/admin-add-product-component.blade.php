                    ...
                    <div class="col-md12">
                        <div class="cart">
                            <div class="card-header">
                                ...
                                <div class="col-md6">
                                    <a href="{{route('admin.products')}}" class="btn btn-succss float-end">All Products</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="addProduct">
                                ...
                                <div class="md-3 mt-3">
                                    ...
                                    <input type="text" name="regular_price" class="form-control" placeholder="Enter price" wire:model="regular_price" />
                                    @error('regular_price')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
